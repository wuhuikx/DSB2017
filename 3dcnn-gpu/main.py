...
data_path = './training/result-wh/prep_luna_full/'
skip_prep = True
if not skip_prep:
...
data_
testsplit = './training/result-wh/inputdata/luna_val.npy'
testsplit = np.load(testsplit)
skip_detect = False
if not skip_detect:
	print('----------------begin detect-------------')    
	margin = 32
	...
	test_detect(test_loader, nod_net, get_pbb, bbox_result_path,
				config1, n_gpu=config_submit['n_gpu'])
