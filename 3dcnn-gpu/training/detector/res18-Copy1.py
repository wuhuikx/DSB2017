...
class Net(nn.Module):
    def __init__(self):
        ...
        '''
        self.conv3dwuhui1 = nn.Sequential(
            nn.Conv3d(1, 24, kernel_size = 3, padding = 1))
        self.bn3dwuhui1 = nn.Sequential(nn.BatchNorm3d(24))
        self.reluwuhui1 = nn.Sequential(nn.ReLU(inplace = True))
        
        self.conv3dwuhui2 = nn.Sequential(
            nn.Conv3d(24, 24, kernel_size = 3, padding = 1))
        self.bn3dwuhui2 = nn.Sequential(nn.BatchNorm3d(24))
        self.reluwuhui2 = nn.Sequential(nn.ReLU(inplace = True))
        #print('self.conv3d =', self.conv3dwuhui)'''
    ...
    def forward(self, x, coord):
        ...
        print('x_size=',x.size())
        print('x=', x[0,0,0:10,0:10,0:10])
        '''
        out = self.conv3dwuhui1(x)
        out = self.bn3dwuhui1(out)
        out = self.reluwuhui1(out)
        out = self.conv3dwuhui2(out)
        out = self.bn3dwuhui2(out)
        out = self.reluwuhui2(out)
        test = out
        print('conv1_size=', test.size())
        print('conv1 =', test[0, 0, 0:10, 0:10, 0:10])'''
        ...
        print('conv1_size=', rev3.size())
        print('conv1 =', rev3[0, 0, 0:10, 0:10, 0:10])
