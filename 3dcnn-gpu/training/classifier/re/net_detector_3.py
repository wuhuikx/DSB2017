...
class Net(nn.Module):
    ...
    def forward(self, x, coord):
        ...
        #print('------------cat0-------------')
        #print('1_out3_pool=',out3_pool.size())
        #print('2_out4=',out4.size())
        #print('------------cat1-------------')
        #print('rev3=',rev3.size())
        ...
        #print('------------cat2-------------')
        #print('rev3=',rev2.size())
        #print('out3=',out2.size())
        #print('coord=',coord.size())
        feat = self.back2(torch.cat((rev2, out2,coord), 1))#64+64
        #print('res=', torch.cat((rev2, out2, coord),1).size())
        ...
        #print('--------3.out-transpose=',out.size())
        #out = out.view(-1, 5)
        #print('out3=',out.size())
